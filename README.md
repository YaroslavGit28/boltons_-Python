...
**Вдохновение / формат документации:** README оформлен в стиле демонстрационного проекта по `argparse` из репозитория [`YaroslavGit28/Argparse_Python`](https://github.com/YaroslavGit28/Argparse_Python), но адаптирован под текущую библиотеку.
